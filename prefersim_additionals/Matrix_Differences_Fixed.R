...
#Matrix Differences for Fixed Parameters. This is used to construct an observed matrix to compare ABC generations to. 
...
write.csv(matriz_conteo_invariables_rangos, paste("../Data/Parameters/Output/matrices/observed_matrices/observed_count_matrix_", SGE_TASK_ID, ".csv", sep=""), row.names = FALSE)
