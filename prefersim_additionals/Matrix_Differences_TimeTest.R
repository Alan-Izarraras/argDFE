...
print(paste("using total number of sites: ", l))
print(paste("divided into ", step, "runs"))
...
write.csv(matriz_conteo_rangos, paste("matriz_conteo_20tiempos_", SGE_TASK_ID, ".csv", sep=""), row.names = FALSE)
