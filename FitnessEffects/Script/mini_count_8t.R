...
#modified for kim et al under estimated 0.01% target size. 
...
file_path <- "../Data/trees/Sel_1/target_size/under_0.01/"
#path where outputs (matrices) are to be placed
out_path <- "../Data/trees/MatrixInputs/ConstantSize/set1/matrices/kim_target_size/under_0.01/"
