...
file_path <- "../Data/trees/MatrixInputs/ConstantSize/set1/reps/diezmil/"
#path where outputs (matrices) are to be placed
out_path <- "../Data/trees/MatrixInputs/ConstantSize/set1/matrices/diezmil/"
...
#this stops when all freqs are represented, so write case where all freqs are observed.
  ...
  #reemplazo --> joins singleton and ancestral count row. 
