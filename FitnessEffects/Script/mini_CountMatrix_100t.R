...
#rangos_tiempo <- rangos_tiempo * 60000
  ...
  write.csv(matriz_conteo_invariables_2, paste(out_path, "200x100_count_",sel, formatC(a, width = 3, flag = "0"), "_sel", sel, ".csv", sep=""), row.names = FALSE)
  ...
  write.csv(matriz_conteo_rangos, paste(out_path, "20x100_count_",sel, formatC(a, width = 3, flag = "0"), "_sel", sel, ".csv", sep=""), row.names = FALSE)
