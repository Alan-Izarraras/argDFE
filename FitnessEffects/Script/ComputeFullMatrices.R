...
#makes full matrices (all frequency values)
#modifying toi ignore empty tree/singleton files.
...
file_path <- "../Data/trees/MatrixInputs/new_likelihood_experiment/second_run/set1/source_trees/reps/cien/"
#path where outputs (matrices) are to be placed
out_path <- "../Data/trees/MatrixInputs/new_likelihood_experiment/second_run/set1/matrices/cien/"

#casos: Si no hay arbol, solo usar singletones. 
#si no hay nada, construir matriz vacia. 
