...
file_path <- "../Data/trees/MatrixInputs/new_likelihood_experiment/second_run/set1/source_trees/reps/"
#path where outputs (matrices) are to be placed
out_path <- "../Data/trees/MatrixInputs/new_likelihood_experiment/second_run/set1/matrices/"
...
#matriz_prob_invariables_rangos <- matriz_conteo_invariables_rangos / max_sitios
  ...
  write.csv(matriz_conteo_invariables_rangos, paste(out_path, "observed_20x8_count_matrix_Sel", sel, "_rep", a, ".csv", sep=""), row.names = FALSE)
...
#matriz_prob_rangos <- matriz_conteo_rangos / max_effective_sites
  ...
  write.csv(matriz_conteo_rangos, paste(out_path, "observed_6x8_count_matrix_Sel", sel, "_rep", a, ".csv", sep=""), row.names = FALSE)
